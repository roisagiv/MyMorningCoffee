...
declare module 'detox' {
    ...
    namespace Detox {
        ...
        interface WaitFor {
             ...
             */
            (element: Detox.Element): Expect<WaitFor>;
            /**
             ...
             */
            whileElement(by: Matchers): Detox.Element;
        }
        interface Actions<R> {
            /**
